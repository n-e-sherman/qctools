...
class ConstrainedAllToAllMosaic(AllToAllMosaic):

    def __init__(self, N, T, max_width=None, max_depth=None, pbc=False, N_initial=1, min_patch_size=1, max_patch_size=4, unassigned_id: int=-1, missing_id: int=-2):
        
        super().__init__(N, T, pbc=pbc, N_initial=N_initial, min_patch_size=min_patch_size, max_patch_size=max_patch_size, unassigned_id=unassigned_id, missing_id=missing_id)
